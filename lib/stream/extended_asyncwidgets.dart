...
import 'package:public_vptax/stream/streamed_object.dart';
...
class ValueBuilder<T> extends StreamBuilder<T> {
  ValueBuilder({required StreamedObject<T> streamed, required this.builder, Key? key, T? initialData, this.noDataChild, this.onNoData, this.errorChild, this.onError})
...
class StreamedWidget<T> extends StreamBuilder<T> {
  const StreamedWidget({required Stream<T> stream, required this.builder, Key? key, this.initialData, this.noDataChild, this.onNoData, this.errorChild, this.onError})
...
class FuturedWidget<T> extends StatelessWidget {
  const FuturedWidget({required this.future, required this.builder, Key? key, this.initialData, this.onWaitingChild, this.onWaiting, this.errorChild, this.onError})
