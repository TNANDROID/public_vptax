...
class TaxCollectionDetailsWithAdd extends StatefulWidget {
  ...
  TaxCollectionDetailsWithAdd({Key? key, required this.selectedTaxTypeData})
      : super(key: key);

  @override
  _TaxCollectionDetailsWithAddState createState() =>
      _TaxCollectionDetailsWithAddState();
}

class _TaxCollectionDetailsWithAddState extends State<TaxCollectionDetailsWithAdd> with SingleTickerProviderStateMixin {
      ...
      children: [
        ...
        Align(
            ...
            child: Container(
              width: 89,
              height: 30,
              margin: EdgeInsets.only(top: 10, right: 30, bottom: 15),
              ...
              child: Row( // Wrap with Row to add the plus icon
                ...
                children: [
                  ...
                  SizedBox(width: 5), // Add a small space between the icon and the text
                  UIHelper.titleTextStyle(
                    "add".tr().toString(),
                    c.white,
                    12,
